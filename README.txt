...
- The login/sign up page will display. If user have already had account, you can simply click on Log In button to login into our system. If not, user click on Sign Up button to register the user with 2 information (username, password, password confirm (must be the same with password))
...
- There are a lot of buttons on page 3, we will talk about 5 sections on the top first, from left to right
  ...
  + Fourth button is the timer of. You will have a specific time to answer your question. Normally is 5:00 (5 minutes) for one level
...
- In the middle, from left to right, there are 3 columns
  + First column will display the popup section when user clicks on meaning button (second button)
